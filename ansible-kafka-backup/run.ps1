...
ansible-playbook -i inventories/kafka-6-vms/hosts.yml playbooks/parallel.yml --tags "certificates_restore" --extra-vars "restore_archive=/backup/cold/certificates/rotated/2025/01/07/2025-01-07---11-26-34---certificate.tar.zx"
...
ansible-playbook -i inventories/kafka-6-vms/hosts.yml playbooks/parallel.yml --tags "credentials_restore" --extra-vars "restore_archive=/backup/cold/certificates/rotated/2025/01/07/2025-01-07---11-26-34---certificate.tar.zx"
ansible-playbook -i inventories/kafka-6-vms/hosts.yml playbooks/parallel.yml --tags "configs_generate"
...
ansible-playbook -i inventories/kafka-6-vms/hosts.yml playbooks/parallel.yml --tags "configs_restore"      --extra-vars "restore_archive=/backup/cold/configs/rotated/2025/01/07/2025-01-07---11-28-08---configs.tar.zx"
